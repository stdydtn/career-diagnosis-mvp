...
export const jobSeekerHints = {
  ...
  상담·코칭: "경청·신뢰 관계·목표 설정 같은 역량을 묻는 문항이 많아요. 상대방 맥락을 정리해 준 경험을 상황·행동·결과 순서로 한 번만 골라 정리해 보세요.",
  ...
  "총무·운영관리": "비품·계약·일정·비용 같은 실무 키워드를 노리세요. 동아리 총무·행사 운영으로 비용·일정을 맡았다면 그 스토리를 상황·행동·결과 순서로 쓰면 됩니다.",
  ...
  기술영업: "고객 니즈·제품 설명·제안 같은 역량을 묻습니다. 아르바이트나 대외활동에서 기술·서비스를 설명해 성과를 낸 일을 상황·행동·결과 순서로 정리해 보세요.",
